...
import nl.hyve.gb.backend.exception.AccessDeniedException
import nl.hyve.gb.backend.exception.InvalidArgumentsException
import nl.hyve.gb.backend.exception.NoSuchResourceException
import nl.hyve.gb.backend.exception.ServiceNotAvailableException
import nl.hyve.gb.backend.representation.QueryRepresentation
import nl.hyve.gb.backend.user.User
...
class QueryService {
    ...
    private static void validateSubscriptionEnabled(Boolean subscribed, SubscriptionFrequency subscriptionFreq) {
        ...
        boolean subscriptionEnabled = Holders.config.getProperty('nl.hyve.gb.backend.notifications.enabled', Boolean)
